# Wang-et-al.-2025-Communications-Biology
...
#####coral nutrition revealed by amino acid δ13C analysis####### 
#####(Wang et al., 2025)########################################
...
##### Overall mixing models using mean-centred δ13CEAA
##### For Fig.3b
##### Load mix data
...
# For Fig4b
# Load mix data
# Seperate raw δ13CEAA data in SUPPLEMENTARY DATA 1
